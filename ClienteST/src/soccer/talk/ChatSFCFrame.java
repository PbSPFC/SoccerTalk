 ...
 * @author PB
 */
public class ChatSFCFrame extends javax.swing.JFrame {

    private Socket socket;
    private ChatMessage msg;
    private ClienteServiceSFC service;
    ...
    public ChatSFCFrame() {
        ...
        if (!nome.isEmpty()) {
            ...
            this.service = new ClienteServiceSFC();
    ...
    private class ListenerSocket implements Runnable {
        ...
        public ListenerSocket(Socket socket) {
            try {
                ...
                Logger.getLogger(ChatSFCFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void initComponents() {
        ...
        panelFont.setBackground(new java.awt.Color(204, 204, 204));
        panelFont.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(255, 255, 255)));

        cbFontes.setBackground(new java.awt.Color(204, 204, 204));
        ...
        lblFonteTeste.setBackground(new java.awt.Color(204, 204, 204));
        ...
        cbBold.setBackground(new java.awt.Color(204, 204, 204));
        ...
        cbItalic.setBackground(new java.awt.Color(204, 204, 204));
        ...
        btnFonteMudar.setBackground(new java.awt.Color(255, 255, 255));
        ...
        cbTamanhoFonte.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jLabel1.setText("Santos Futebol Clube");
