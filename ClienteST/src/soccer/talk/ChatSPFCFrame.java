 ...
 * @author PB
 */
public class ChatSPFCFrame extends javax.swing.JFrame {

    private Socket socket;
    private ChatMessage msg;
    private ClienteServiceSPFC service;
    private static String nome = "";
    private static String time = "";

    public ChatSPFCFrame() {
        initComponents();
        ...
        if (!nome.isEmpty()) {
            ...
            this.service = new ClienteServiceSPFC();
    ...
    private class ListenerSocket implements Runnable {
        ...
        public ListenerSocket(Socket socket) {
            try {
                ...
                Logger.getLogger(ChatSPFCFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void initComponents() {
        ...
        jTabbedPane2.setBackground(new java.awt.Color(255, 0, 0));
        ...
        btnLimpar.setForeground(new java.awt.Color(204, 204, 0));
        ...
        btnEnviar.setForeground(new java.awt.Color(204, 204, 0));
        ...
        btnSair.setForeground(new java.awt.Color(204, 204, 0));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(0, 0, 0)), "Onlines"));
        ...
        panelFont.setBackground(new java.awt.Color(255, 0, 0));
        panelFont.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(0, 0, 0)));

        cbFontes.setBackground(new java.awt.Color(255, 0, 0));
        ...
        lblFonteTeste.setBackground(new java.awt.Color(255, 0, 0));
        ...
        cbBold.setBackground(new java.awt.Color(255, 0, 0));
        ...
        cbItalic.setBackground(new java.awt.Color(255, 0, 0));
        ...
        btnFonteMudar.setBackground(new java.awt.Color(255, 0, 0));
        btnFonteMudar.setText("Mudar Fonte");
        btnFonteMudar.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(255, 255, 255)));
        ...
        cbTamanhoFonte.setBackground(new java.awt.Color(255, 0, 0));
        ...
        jLabel1.setText("São Paulo Futebol Clube");
